...
const ClustersMockClientV1_1 = require("../version1/ClustersMockClientV1");
...
class ClustersClientFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(ClustersClientFactory.MockClientV1Descriptor, ClustersMockClientV1_1.ClustersMockClientV1);
...
ClustersClientFactory.MockClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-clusters', 'client', 'mock', 'default', '1.0');
